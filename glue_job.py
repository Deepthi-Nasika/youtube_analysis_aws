...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "db_youtube_raw", table_name = "raw_stats", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://project1-youtube-cleansed-useast1-dev/youtube/raw_stats_json/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
